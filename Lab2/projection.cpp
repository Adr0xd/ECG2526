...
namespace egc {
    ...
    mat4 defineViewTransformMatrix(const int startX, const int startY, const int width, const int height)
    {
		auto viewTransformMatrix = mat4();
        ...
        auto smtMatrix = mat4(srcSMTMatrix);
        const auto translationMatrix = translate(startX, startY, 0.0f);

        viewTransformMatrix = smtMatrix * translationMatrix;

...
int testVec2Implementation()
{
    ...
    egc::Vector2D v1, v2, v3, v4;
    
    v1.x = 1.0f;
    v2.y = 1.0f;
    
    v3 = v1 + v2;
    if(v3 == egc::Vector2D(1.0f, 1.0f))
...
int testVec3Implementation()
{
    ...
    egc::Vector3D v1, v2, v3, v4;
    
    v1.x = 1.0f;
    v2.y = 1.0f;
    
    v3 = v1 + v2;
    if(v3 == egc::Vector3D(1.0f, 1.0f, 0.0f))
        std::cout << "\tCorrect + operation" << std::endl;
    else
    {
        std::cout << "\tIncorrect + operation" << std::endl;
    ...
    v3 += v1;
    if(v3 == egc::Vector3D(2.0f, 1.0f, 0.0f))
        std::cout << "\tCorrect += operation" << std::endl;
    else
    {
        std::cout << "\tIncorrect += operation" << std::endl;
    ...
    v3 = egc::Vector3D(2.0f, 1.0f, 0.0f) - v1;
    if(v3 == egc::Vector3D(1.0f, 1.0f, 0.0f))
        std::cout << "\tCorrect - operation" << std::endl;
    else
    {
    ...
    v3 -= v1;
    if(v3 == egc::Vector3D(0.0f, 1.0f, 0.0f))
        std::cout << "\tCorrect -= operation" << std::endl;
    else
    {
        std::cout << "\tIncorrect -= operation" << std::endl;
    ...
    v3 = egc::Vector3D(2.0f, 4.0f, 4.0f);
    if(v3.length() == 6.0f)
        std::cout << "\tCorrect length operation" << std::endl;
    else
    {
    ...
    v4 = v3.normalize();
    if(v4 == egc::Vector3D(2.0f / 6.0f, 4.0f / 6.0f, 4.0f / 6.0f))
        std::cout << "\tCorrect normalize operation" << std::endl;
    else
    {
        std::cout << "\tIncorrect normalize operation" << std::endl;
    ...
    if(v4 == egc::Vector3D(0.0f, 0.0f, 1.0f))
...
int testVec4Implementation()
{
    ...
    egc::Vector4D v1, v2, v3, v4;
    
    v1.x = 1.0f;
    v2.y = 1.0f;
    
    v3 = v1 + v2;
    if(v3 == egc::Vector4D(1.0f, 1.0f, 0.0f, 0.0f))
        std::cout << "\tCorrect + operation" << std::endl;
    else
    {
        std::cout << "\tIncorrect + operation" << std::endl;
    ...
    v3 += v1;
    if(v3 == egc::Vector4D(2.0f, 1.0f, 0.0f, 0.0f))
        std::cout << "\tCorrect += operation" << std::endl;
    else
    {
        std::cout << "\tIncorrect += operation" << std::endl;
    ...
    v3 = egc::Vector4D(2.0f, 1.0f, 0.0f, 0.0f) - v1;
    if(v3 == egc::Vector4D(1.0f, 1.0f, 0.0f, 0.0f))
        std::cout << "\tCorrect - operation" << std::endl;
    else
    {
    ...
    v3 -= v1;
    if(v3 == egc::Vector4D(0.0f, 1.0f, 0.0f, 0.0f))
        std::cout << "\tCorrect -= operation" << std::endl;
    else
    {
        std::cout << "\tIncorrect -= operation" << std::endl;
    ...
    v3 = egc::Vector4D(2.0f, 4.0f, 4.0f, 0.0f);
    if(v3.length() == 6.0f)
        std::cout << "\tCorrect length operation" << std::endl;
    else
    {
    ...
    v4 = v3.normalize();
    if(v4 == egc::Vector4D(2.0f / 6.0f, 4.0f / 6.0f, 4.0f / 6.0f, 0.0f))
        std::cout << "\tCorrect normalize operation" << std::endl;
    else
    {
        std::cout << "\tIncorrect normalize operation" << std::endl;
